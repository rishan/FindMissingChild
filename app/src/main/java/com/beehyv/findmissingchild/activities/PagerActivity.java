...
import com.beehyv.findmissingchild.pojos.OBItem;
...
public class PagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button mFinishBtn=(Button)findViewById(R.id.intro_btn_finish);
        final Button mSkipBtn=(Button)findViewById(R.id.intro_btn_skip);
        ...
        mFinishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Utils.saveSharedSetting(PagerActivity.this, Utils.PREFERENCES_FILE, false);
            }
        });
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            OBItem obItem=OBItem.OBObjectSender(getArguments().getInt(ARG_SECTION_NUMBER));
            TextView textView = (TextView) rootView.findViewById(R.id.section_label);
            ImageView obNumber = (ImageView)rootView.findViewById(R.id.obNumber);
            ImageView obImage = (ImageView)rootView.findViewById(R.id.obImage);
            textView.setText(obItem.getSectionText());
            obNumber.setImageResource(obItem.getObNumberImage());
            obImage.setImageResource(obItem.getObImage());
            return rootView;
        }
    }
